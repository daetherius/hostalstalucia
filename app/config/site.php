<?php
$config['Site'] = array(
	'name'=>'Hostal Santa Lucía',
	'domain'=>$_SERVER['SERVER_NAME'],
	'email'=>'hostalstalucia@gmail.com',
	'slogan'=>'',
	'keywords'=>'',
	'description'=>'En el hostal Sta Lucia encontrarás un agradable ambiente estilo colonial Mexicano, también podrás disfrutar de clases de salsa, parrilladas BBQ por las noches, un ambiente rustico a la luz de las velas, limpieza excelentes instalaciones y nuestro trato cálido el cual harán que tu estancia en Mérida sea de lo mejor e inolvidable.'
);
